...
/* Capacity of the completion queue (CQ) 16*/
...
#define DEFAULT_RDMA_PORT (32768)
/* */
#define ONE_GB (uint64_t)(1<<30)
 ...
 * ibv_access_flags
 */
struct ibv_mr *rdma_buffer_alloc(struct ibv_pd *pd, uint64_t length,
